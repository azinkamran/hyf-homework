...
//home work2
const mealsId = require("./routes/mealsId.js");
app.get("/mealsId", mealsId);
const reservationId = require("./routes/reservationsId.js");
app.get("/reservationsId", reservationId);
const reviewRouter = require("./routes/reviews.js");
app.get("/reviews", reviewRouter);
const reviewId = require("./routes/reviewId.js");
app.get("/reviewId", reviewId);
